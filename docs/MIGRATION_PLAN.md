...
| F | 音訊標籤（F-01～F-15） |
| G | 桌面整合（G-01、G-03、G-06、G-10、G-14） |
| H | 命令列相容（H-01～H-05） |
| I | 平台差異（I-09） |
| J | 測試與發行（J-01～J-03、J-07、J-09～J-10、J-13） |
| K | 退場閘門（K-02） |
...
- Linux X11 已有部分截圖（見 `docs/acceptance/2026-08-15/`），但多項仍缺操作錄影、跨平台（Windows）或完整對話流程證據。
- J-05／J-06：本機曾產出 AppImage、DEB、RPM 與雜湊，仍缺正式 Release 工作流程產物對照。
- J-11：APT／DEB 已在 QEMU 驗證；本機 RPM `Requires` 已檢查；DNF 實裝安裝仍未跑。
- G-02、G-05、G-07 等在 Linux 本機已有截圖，但驗收條件要求 Windows 與 Linux 證據齊全，故維持待人工驗收。
- 詳細本機與 CI 日誌見 [MIGRATION_COMPLETED.md](MIGRATION_COMPLETED.md) 的「歷史驗收紀錄」。
