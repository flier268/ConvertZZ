...
<template>
  <section v-if="settings" class="page-stack">
    ...
    <el-card shadow="never"
      ><template #header><div class="section-title">一般</div></template
    ...
    >
    <el-card shadow="never"
      ><template #header><div class="section-title">檔案轉換</div></template
      ...
      ><el-checkbox v-model="settings.files.unicodeAddBom"
        >Unicode 輸出加入 BOM</el-checkbox
      ></el-card
    >
    <el-card shadow="never"
      ><template #header><div class="section-title">全域快捷鍵</div></template
      ><el-alert
          ...
          ><template #default="scope"
            ><el-select
              ...
              ><el-option
                ...
                :key="action.value"
                :label="action.label"
                :value="action.value" /></el-select></template></el-table-column></el-table
    ></el-card>
    <el-card shadow="never"
      ><template #header><div class="section-title">ZhConvert API</div></template>
      ...
      <el-form label-position="top" class="option-grid"
        ...
        ><el-form-item label="視為日文的字幕樣式"
          ><el-input v-model="settings.zhconvert.jpTextStyles" /></el-form-item></el-form
      ><el-form label-position="top"
      ...
      <div class="switch-row">
        ...
        ><el-checkbox v-model="settings.zhconvert.trimTrailingWhiteSpaces">移除行尾空白</el-checkbox
        ><el-checkbox v-model="settings.zhconvert.unifyLeadingHyphen">統一行首連字號</el-checkbox>
      </div>
      <p class="legal-note">使用此服務時必須遵守繁化姬的署名與商業使用條款。</p></el-card
    >
    <el-card v-if="capabilities?.sendToShortcut" shadow="never"
      ><template #header><div class="section-title">Windows 整合</div></template
      ><el-button
        @click="
